...
* Enhanced some string translations.

= 1.4.5 =
* Tested OK with WooCommerce 9.0
* Added string translations for the Italian language.
...
= 1.4.2 =
* Fixed an issue with adding attributes to the products.

= 1.4.1 =
* Fixed an issue related to Product image.
...
* Added padding and delimiter for setting up new SKU values
Bug fixes
