...
<div class="notice elex-banner-notice">
		<div class="elex-banner-wrap">
			<div class="elex-banner-row">
				...
				<h5 style="font-size: 18px; margin-top: 0; margin-bottom: 10px;"><?php echo esc_html__( 'Trouble setting up the Plugin?', 'eh_bulk_edit' ); ?></h5>
					<p style="font-size:16px; line-height: 1.5; margin-top:0; margin-bottom:10px;">
						<?php
						printf(
							// translators: %1$s is replaced with the plugin name.
							esc_html__(
								'Need help on setting up %1$s plugin? You may go through our detailed documentation. For any further assistance, please don\'t hesitate to reach out to our amazing support team.',
								'eh_bulk_edit'
							),
					...
					<div class="elex-banner-button-wrap">
						...
						">
							...
							<?php echo esc_html__( 'Never ask again', 'eh_bulk_edit' ); ?>
						</a>
						<a class="button elex-btn-hover-light text-nowrap d-flex align-items-center gap-2" href="<?php echo esc_url( $this->data['documentation_url'] ); ?>" target="_blank">
							...
							<?php echo esc_html__( 'Read Documentation', 'eh_bulk_edit' ); ?>
						</a>
						<a class="button button-primary" href="<?php echo esc_url( $this->data['support_url'] ); ?>" target="_blank">
							...
							<?php echo esc_html__( 'Contact Support', 'eh_bulk_edit' ); ?>
						</a>
					</div>
				</div>
				<?php
